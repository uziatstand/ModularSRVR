...
public class wallmesh2 : MonoBehaviour {
    ...
    {
        vertices[0] = new Vector3(-100,50,-20);
        vertices[1] = new Vector3(-100,0,-20);
        vertices[2] = new Vector3(100,0,-20);
        vertices[3] = new Vector3(100,50,-20);

        baseVert[0] = new Vector3(-100,50,-20);
        baseVert[1] = new Vector3(-100,0,-20);
        baseVert[2] = new Vector3(100,0,-20);
        baseVert[3] = new Vector3(100,50,-20);
